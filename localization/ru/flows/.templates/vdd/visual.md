...
ASCII mockups и visual flows для alignment на внешнем виде функции и user experience перед технической спецификацией.

---

## Screen: [Имя Screen]

[Описание что делает этот screen]
...
## Component: [Имя Component]

[Описание reusable component]
